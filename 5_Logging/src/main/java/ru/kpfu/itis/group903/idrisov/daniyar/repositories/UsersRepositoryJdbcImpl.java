package ru.kpfu.itis.group903.idrisov.daniyar.config.repositories;

import ru.kpfu.itis.group903.idrisov.daniyar.model.User;
import ru.kpfu.itis.group903.idrisov.daniyar.repositories.RowMapper;
import ru.kpfu.itis.group903.idrisov.daniyar.repositories.SimpleJdbcTemplate;
...
public class UsersRepositoryJdbcImpl implements UsersRepository {
    ...
    //language=SQL
    private static final String SQL_FIND_BY_LOGIN = "select * from users where login = ? and password = ?";
    ...
    public List<User> findByLoginAndPassword(String login, String password) {
        ...
        return simpleJdbcTemplate.query(SQL_FIND_BY_LOGIN, userRowMapper, login, password);
